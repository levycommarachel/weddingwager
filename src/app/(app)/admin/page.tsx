...
import { Trash2, PlusCircle, Shield, ListCollapse } from 'lucide-react';
...
export default function AdminPage() {
    ...
    function onSubmit(values: z.infer<typeof betFormSchema>) {
    ...
    const activeBets = bets.filter(b => !b.isSettled);
                            ...
                            {activeBets.map((bet, index) => (
                                <React.Fragment key={bet.id}>
                                    <div className="flex items-center justify-between p-4">
                                        ...
                                        <Button variant="destructive" size="sm" onClick={() => settleBet(bet.id)}>
